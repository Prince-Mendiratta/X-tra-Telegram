...
USER_BOT_WARN_ZERO = "`لقد ارسلت الكثير من الرسائل المزعجه الى سيدي 😒🤚🏻 ، من الأن فصاعداََ تم حظرك من قبل برنامج الحمايه الخاص بي 🌝🌿.` **Now GTFO, i'm playing minecraft** "
USER_BOT_NO_WARN = ("[──▄█▀█▄─────────██ \n▄████████▄───▄▀█▄▄▄▄ \n██▀▼▼▼▼▼─▄▀──█▄▄ \n█████▄▲▲▲─▄▄▄▀───▀▄ \n██████▀▀▀▀─▀────────▀▀](tg://user?id=)\n\n"
                    "`مرحباََ ... انا مسؤل الأمان هنا 👨‍💻🦾 \n لقد وجَدت طريقك هنا الى سيدي,`"
                    f"{DEFAULTUSER}`\n\n"
                    "اترك أسمك ورقم هاتفك وعنوانك و 10 آلاف دولار ونأمل أن تحصل على رد في غضون سنتين ضوئيتين🌝🌿.`\n\n"
