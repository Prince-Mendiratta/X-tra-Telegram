...
USER_BOT_WARN_ZERO = "`لقد كنت تزعج الزعيمه عَسل ، ومن الآن فصاعدًا تم حظرك بواسطة برنامج الحماية الخاص بي🌝🌿.` "
USER_BOT_NO_WARN = ("\n╔══╗ \n║██║ \n║(O)║ ♫ ♪ ♫ ♪ \n╚══╝ \n▄ █ ▄ █ ▄ ▄ █ ▄ █ ▄ █\nMin- - - - - - - - - - - -●Max\n         (☞ﾟヮﾟ)☞\n\n"
                    "`مرحباً ! انا مديرة الحساب ` **H.O.N.E.Y**\n"
                    "`بروتوكول أمان المراسلة الخاصة ⚠️`\n\n"
                    "**حاليااً 𝙷𝙾𝙽𝙴𝚈**\n"
                    f"{DEFAULTUSER} مشغوله ! لذا من الافضل عدم ارسال الرسائل المزعجة 🌝🌿!\n\n"
                    f"{CUSTOM_MIDDLE_PMP} \n\n"
