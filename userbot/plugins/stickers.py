...
async def _(event):
    ...
    packname = f"@Halto_Tha ki gufa me"
    packshortname = f"Jayu_ke_locker_me"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"Jayu's @AnimatedStickersGroup"
        if userid == 719877937:
            packshortname = "Jayu_Animated"
        else:
            packshortname = f"Jayu's_Animations" # format: Uni_Borg_userid
