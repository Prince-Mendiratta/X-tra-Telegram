    ...
    if not pmpermit_sql.is_approved(chat_id):
        ...
        if event.is_private:
         ...
         PM = ("`مرحباً.  لقد تم ايصالك إلى القائمة المتاحة للسيد ѕᴀѕᴋᴇ ʟ̤ɾʅ丂ɹɹɹȊɹɹɹ ,`"
               ...
               "`4`. لطلب شيء 🎭\n")
         ONE = ("حسناً. تم تسجيل طلبك. لا ترسل المزيد من الرسائل المزعجه إلى أستاذي. يمكنك توقع الرد في غضون 24 سنة ضوئية. إنه رجل مشغول ، على عكسك على الأرجح(¬‿¬) .\n\n"
