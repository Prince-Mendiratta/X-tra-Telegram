    ...
    if not pmpermit_sql.is_approved(chat_id):
        ...
        if event.is_private:
         ...
         PM = ("`مرحباً.  لقد تم ايصالك إلى القائمة المتاحة للسيدة 𝙷𝙾𝙽𝙴𝚈 ,`"
               ...
               "`4`. لطلب شيء 🎭\n")
         ONE = ("__حسناً. تم تسجيل طلبك. لا ترسل المزيد من الرسائل المزعجه إلى سيدتي. يمكنك توقع الرد في غضون 24 سنة ضوئية. إنها فتاة مشغولة ، على عكسك على الأرجح(¬‿¬) .__\n\n"
         ...
         FOUR = ("__حسناً. لم تطلع سيدتي على رسالتك حتى الآن ، وعادةً لا ترد على الزواحف ، على الرغم من ذلك ساقوم بايصال رسالتك لسيدتي🌿 .__\n __سترد عندما تعود إذا أرادت ذلك ، فهناك بالفعل الكثير من الرسائل المعلقة😶__\n **من فضلك لا ترسل شيٌ أخر إلا إذا كنت ترغب في أن يتم حظرك والإبلاغ عنك (●'◡'●).**")
         FIVE = ("`حسنا. يرجى الحصول على الأخلاق الأساسية لعدم إزعاج سيدتي كثيرا. إذا كان يرغب في مساعدتك ، فسوف ترد عليك قريبًا 👀.`\n**لا تسأل مرارا وتكرارا وإلا سيتم حظرك والإبلاغ عنك.**")
         LWARN = ("**هذا هو التحذير الأخير الخاص بك. لا ترسل رسالة أخرى وإلا سيتم حظرك والإبلاغ عنك. كن صابر. سيدتي سوف ترد عليك في اسرع وقت ممكن 🌝🌿.**")
